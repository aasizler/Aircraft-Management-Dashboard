      ...
      <body className="flex min-h-full flex-col">
        ...
        <script
          dangerouslySetInnerHTML={{
            __html:
              "try{var A={blue:'#0e77d6',cyan:'#22d3ee',violet:'#8b5cf6',magenta:'#ec4899',silver:'#e2e8f0',green:'#22d3ee',mint:'#22d3ee',purple:'#8b5cf6',red:'#ec4899',amber:'#ec4899',slate:'#e2e8f0'};" +
